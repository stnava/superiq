...
def main(input_config):
    ...
    output_filename_sr = output_filename + "_OR.nii.gz"
    output_filename_sr_seg_init = output_filename  +  "_OR_seginit.nii.gz"
    output_filename_sr_seg = output_filename  +  "_OR_seg.nii.gz"
    output_filename_ortho_plot = output_filename  +  "_ortho_plot_OR.png"
    output_filename_sr_seg_csv = output_filename  + "_OR_seg.csv"
    
    bfOR = basalforebrainOR(
    ...
    ants.image_write(bfOR['OR_Seg_Init'], output_filename_or_seg_init)  
