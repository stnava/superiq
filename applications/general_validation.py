...
#):
#    records = []
#    for k in range(len(atlas_images_path)):
#        # Get the name of the target 
#        localid=os.path.splitext( os.path.splitext( os.path.basename( atlas_images_path[k]) )[0])[0]
#        #localid='test'
#        print( str(k) + " " + localid)
...
def cross_validation(
    ...
    target_image_name = evaluation_parameters['target_image_name'] 
